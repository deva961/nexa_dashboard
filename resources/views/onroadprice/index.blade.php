                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">On Road Price</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('onroadprice.getdate') }}" method="post">
                                    <div class="row">
                                        @csrf
                                        <div class="col-md-8">
                                            <div class="mb-4">
                                                ...
                                                <div class="input-daterange input-group" id="datepicker6"
                                                    ...
                                                    <input type="text" class="form-control" name="minDate" autocomplete="off"
                                                        placeholder="Start Date" />
                                                    <input type="text" class="form-control" name="maxDate" autocomplete="off"
                                ...
                                <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                    ...
                                    <tbody>
                                        @foreach ($onRoadPrices as $key => $item)
                                            <tr>
                                                <td>{{ ++$key }}</td>
                                                <td>{{ $item->name }}</td>
                                                <td>{{ $item->email }}</td>
